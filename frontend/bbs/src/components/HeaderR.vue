...
<!--				</el-col>-->
				...
				<el-col :push="7" :span="2">
					<el-link type="info" v-show="logged" class="header-text" @click="$router.push('/profile')">个人中心</el-link>
				</el-col>
				<el-col :push="4" :span="3">
					<el-input @keyup.enter.native="searchPost" class="el-icon-search" v-model="queryData" placeholder="搜索帖子"/>
				</el-col>
